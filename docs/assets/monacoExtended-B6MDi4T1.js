...
void main() {
	...
	`}function kp(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===Ea||c===ba,h=c===Xi||c===qi;if(l||h){let u=e.get(o);const f=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new _l(i)),u=l?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const p=o.image;return l&&p&&p.height>0||h&&p&&s(p)?(t===null&&(t=new _l(i)),u=l?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let c=0;const l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function zp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&oi("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function Vp(i,e,t,n){const s={},r=new WeakMap;function a(u){const f=u.target;f.index!==null&&e.remove(f.index);for(const x in f.attributes)e.remove(f.attributes[x]);f.removeEventListener("dispose",a),delete s[f.id];const p=r.get(f);p&&(e.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(u,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,t.memory.geometries++),f}function c(u){const f=u.attributes;for(const p in f)e.update(f[p],i.ARRAY_BUFFER)}function l(u){const f=[],p=u.index,x=u.attributes.position;let v=0;if(p!==null){const R=p.array;v=p.version;for(let C=0,A=R.length;C<A;C+=3){const L=R[C+0],I=R[C+1],U=R[C+2];f.push(L,I,I,U,U,L)}}else if(x!==void 0){const R=x.array;v=x.version;for(let C=0,A=R.length/3-1;C<A;C+=3){const L=C+0,I=C+1,U=C+2;f.push(L,I,I,U,U,L)}}else return;const m=new(rc(f)?hc:cc)(f,1);m.version=v;const d=r.get(u);d&&e.remove(d),r.set(u,m)}function h(u){const f=r.get(u);if(f){const p=u.index;p!==null&&f.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function Hp(i,e,t){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function c(f,p){i.drawElements(n,p,r,f*a),t.update(p,n,1)}function l(f,p,x){x!==0&&(i.drawElementsInstanced(n,p,r,f*a,x),t.update(p,n,x))}function h(f,p,x){if(x===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,x);let m=0;for(let d=0;d<x;d++)m+=p[d];t.update(m,n,1)}function u(f,p,x,v){if(x===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)l(f[d]/a,p[d],v[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,v,0,x);let d=0;for(let R=0;R<x;R++)d+=p[R]*v[R];t.update(d,n,1)}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Gp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Wp(i,e,t){const n=new WeakMap,s=new mt;function r(a,o,c){const l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let f=n.get(o);if(f===void 0||f.count!==u){let y=function(){U.dispose(),n.delete(o),o.removeEventListener("dispose",y)};f!==void 0&&f.texture.dispose();const p=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,v=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],d=o.morphAttributes.normal||[],R=o.morphAttributes.color||[];let C=0;p===!0&&(C=1),x===!0&&(C=2),v===!0&&(C=3);let A=o.attributes.position.count*C,L=1;A>e.maxTextureSize&&(L=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const I=new Float32Array(A*L*4*u),U=new ac(I,A,L,u);U.type=Sn,U.needsUpdate=!0;const N=C*4;for(let M=0;M<u;M++){const D=m[M],z=d[M],H=R[M],Z=A*L*4*M;for(let ee=0;ee<D.count;ee++){const O=ee*N;p===!0&&(s.fromBufferAttribute(D,ee),I[Z+O+0]=s.x,I[Z+O+1]=s.y,I[Z+O+2]=s.z,I[Z+O+3]=0),x===!0&&(s.fromBufferAttribute(z,ee),I[Z+O+4]=s.x,I[Z+O+5]=s.y,I[Z+O+6]=s.z,I[Z+O+7]=0),v===!0&&(s.fromBufferAttribute(H,ee),I[Z+O+8]=s.x,I[Z+O+9]=s.y,I[Z+O+10]=s.z,I[Z+O+11]=H.itemSize===4?s.w:1)}}f={count:u,texture:U,size:new Ye(A,L)},n.set(o,f),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let p=0;for(let v=0;v<l.length;v++)p+=l[v];const x=o.morphTargetsRelative?1:1-p;c.getUniforms().setValue(i,"morphTargetBaseInfluence",x),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Xp(i,e,t,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(s.get(u)!==l&&(e.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;s.get(f)!==l&&(f.update(),s.set(f,l))}return u}function a(){s=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:a}}const wc=new Yt,yl=new xc(1,1),Cc=new ac,Rc=new $h,Pc=new fc,Sl=[],El=[],bl=new Float32Array(16),Tl=new Float32Array(9),Al=new Float32Array(4);function is(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Sl[s];if(r===void 0&&(r=new Float32Array(s),Sl[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Ot(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Bt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function br(i,e){let t=El[e];t===void 0&&(t=new Int32Array(e),El[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function qp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Yp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ot(t,e))return;i.uniform2fv(this.addr,e),Bt(t,e)}}function jp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Ot(t,e))return;i.uniform3fv(this.addr,e),Bt(t,e)}}function Zp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ot(t,e))return;i.uniform4fv(this.addr,e),Bt(t,e)}}function Kp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ot(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Bt(t,e)}else{if(Ot(t,n))return;Al.set(n),i.uniformMatrix2fv(this.addr,!1,Al),Bt(t,n)}}function Jp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ot(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Bt(t,e)}else{if(Ot(t,n))return;Tl.set(n),i.uniformMatrix3fv(this.addr,!1,Tl),Bt(t,n)}}function $p(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Ot(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Bt(t,e)}else{if(Ot(t,n))return;bl.set(n),i.uniformMatrix4fv(this.addr,!1,bl),Bt(t,n)}}function Qp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function em(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ot(t,e))return;i.uniform2iv(this.addr,e),Bt(t,e)}}function tm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ot(t,e))return;i.uniform3iv(this.addr,e),Bt(t,e)}}function nm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ot(t,e))return;i.uniform4iv(this.addr,e),Bt(t,e)}}function im(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function sm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Ot(t,e))return;i.uniform2uiv(this.addr,e),Bt(t,e)}}function rm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Ot(t,e))return;i.uniform3uiv(this.addr,e),Bt(t,e)}}function am(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Ot(t,e))return;i.uniform4uiv(this.addr,e),Bt(t,e)}}function om(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(yl.compareFunction=sc,r=yl):r=wc,t.setTexture2D(e||r,s)}function lm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Rc,s)}function cm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Pc,s)}function hm(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Cc,s)}function um(i){switch(i){case 5126:return qp;case 35664:return Yp;case 35665:return jp;case 35666:return Zp;case 35674:return Kp;case 35675:return Jp;case 35676:return $p;case 5124:case 35670:return Qp;case 35667:case 35671:return em;case 35668:case 35672:return tm;case 35669:case 35673:return nm;case 5125:return im;case 36294:return sm;case 36295:return rm;case 36296:return am;case 35678:case 36198:case 36298:case 36306:case 35682:return om;case 35679:case 36299:case 36307:return lm;case 35680:case 36300:case 36308:case 36293:return cm;case 36289:case 36303:case 36311:case 36292:return hm}}function dm(i,e){i.uniform1fv(this.addr,e)}function fm(i,e){const t=is(e,this.size,2);i.uniform2fv(this.addr,t)}function pm(i,e){const t=is(e,this.size,3);i.uniform3fv(this.addr,t)}function mm(i,e){const t=is(e,this.size,4);i.uniform4fv(this.addr,t)}function gm(i,e){const t=is(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function _m(i,e){const t=is(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function xm(i,e){const t=is(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function vm(i,e){i.uniform1iv(this.addr,e)}function Mm(i,e){i.uniform2iv(this.addr,e)}function ym(i,e){i.uniform3iv(this.addr,e)}function Sm(i,e){i.uniform4iv(this.addr,e)}function Em(i,e){i.uniform1uiv(this.addr,e)}function bm(i,e){i.uniform2uiv(this.addr,e)}function Tm(i,e){i.uniform3uiv(this.addr,e)}function Am(i,e){i.uniform4uiv(this.addr,e)}function wm(i,e,t){const n=this.cache,s=e.length,r=br(t,s);Ot(n,r)||(i.uniform1iv(this.addr,r),Bt(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||wc,r[a])}function Cm(i,e,t){const n=this.cache,s=e.length,r=br(t,s);Ot(n,r)||(i.uniform1iv(this.addr,r),Bt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Rc,r[a])}function Rm(i,e,t){const n=this.cache,s=e.length,r=br(t,s);Ot(n,r)||(i.uniform1iv(this.addr,r),Bt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Pc,r[a])}function Pm(i,e,t){const n=this.cache,s=e.length,r=br(t,s);Ot(n,r)||(i.uniform1iv(this.addr,r),Bt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Cc,r[a])}function Im(i){switch(i){case 5126:return dm;case 35664:return fm;case 35665:return pm;case 35666:return mm;case 35674:return gm;case 35675:return _m;case 35676:return xm;case 5124:case 35670:return vm;case 35667:case 35671:return Mm;case 35668:case 35672:return ym;case 35669:case 35673:return Sm;case 5125:return Em;case 36294:return bm;case 36295:return Tm;case 36296:return Am;case 35678:case 36198:case 36298:case 36306:case 35682:return wm;case 35679:case 36299:case 36307:return Cm;case 35680:case 36300:case 36308:case 36293:return Rm;case 36289:case 36303:case 36311:case 36292:return Pm}}class Lm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=um(t.type)}}class Dm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Im(t.type)}}class Nm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const ua=/(\w+)(\])?(\[|\.)?/g;function wl(i,e){i.seq.push(e),i.map[e.id]=e}function Um(i,e,t){const n=i.name,s=n.length;for(ua.lastIndex=0;;){const r=ua.exec(n),a=ua.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){wl(t,l===void 0?new Lm(o,i,e):new Dm(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new Nm(o),wl(t,u)),t=u}}}class hr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);Um(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Cl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Fm=37297;let Om=0;function Bm(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Rl=new et;function km(i){lt._getMatrix(Rl,lt.workingColorSpace,i);const e=`mat3( ${Rl.elements.map(t=>t.toFixed(4))} )`;switch(lt.getTransfer(i)){case dr:return[e,"LinearTransferOETF"];case xt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Pl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`
...
`)}function Vm(i,e){let t;switch(e){case oh:t="Linear";break;case lh:t="Reinhard";break;case ch:t="Cineon";break;case hh:t="ACESFilmic";break;case dh:t="AgX";break;case fh:t="Neutral";break;case uh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Qs=new B;function Hm(){lt.getLuminanceCoefficients(Qs);const i=Qs.x.toFixed(4),e=Qs.y.toFixed(4),t=Qs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Jm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Xl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===ql?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Dn&&(e="SHADOWMAP_TYPE_VSM"),e}function $m(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Xi:case qi:e="ENVMAP_TYPE_CUBE";break;case Mr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Qm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case qi:e="ENVMAP_MODE_REFRACTION";break}return e}function eg(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case vr:e="ENVMAP_BLENDING_MULTIPLY";break;case rh:e="ENVMAP_BLENDING_MIX";break;case ah:e="ENVMAP_BLENDING_ADD";break}return e}function tg(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function ng(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Jm(t),l=$m(t),h=Qm(t),u=eg(t),f=tg(t),p=Gm(t),x=Wm(r),v=s.createProgram();let m,d,R=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+d);const C=R+m+a,A=R+d+o,L=Cl(s,s.VERTEX_SHADER,C),I=Cl(s,s.FRAGMENT_SHADER,A);s.attachShader(v,L),s.attachShader(v,I),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function U(D){if(i.debug.checkShaderErrors){const z=s.getProgramInfoLog(v).trim(),H=s.getShaderInfoLog(L).trim(),Z=s.getShaderInfoLog(I).trim();let ee=!0,O=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(ee=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,L,I);else{const se=Pl(s,L,"vertex"),W=Pl(s,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
`,g),null}const ei=Et.getAttribute("version");console.debug("THREE.ColladaLoader: File version",ei);const St=h(n(Et,"asset")[0]),jt=new Sc(this.manager);jt.setPath(this.resourcePath||t).setCrossOrigin(this.crossOrigin);let Gt;zl&&(Gt=new zl(this.manager),Gt.setPath(this.resourcePath||t));const Lt=new Je,Ut=[];let xi={},Tn=0;const Ge={animations:{},clips:{},controllers:{},images:{},effects:{},materials:{},cameras:{},lights:{},geometries:{},nodes:{},visualScenes:{},kinematicsModels:{},physicsModels:{},kinematicsScenes:{}};p(Et,"library_animations","animation",m),p(Et,"library_animation_clips","animation_clip",O),p(Et,"library_controllers","controller",oe),p(Et,"library_images","image",Q),p(Et,"library_effects","effect",je),p(Et,"library_materials","material",le),p(Et,"library_cameras","camera",Ae),p(Et,"library_lights","light",Re),p(Et,"library_geometries","geometry",xe),p(Et,"library_nodes","node",j),p(Et,"library_visual_scenes","visual_scene",ut),p(Et,"library_kinematics_models","kinematics_model",fn),p(Et,"library_physics_models","physics_model",_i),p(Et,"scene","instance_kinematics_scene",Ar),x(Ge.animations,C),x(Ge.clips,se),x(Ge.controllers,Ee),x(Ge.images,te),x(Ge.effects,q),x(Ge.materials,Le),x(Ge.cameras,He),x(Ge.lights,gt),x(Ge.geometries,Tt),x(Ge.visualScenes,Ct),Nt(),Pr();const Cs=ze(n(Et,"scene")[0]);return Cs.animations=Ut,St.upAxis==="Z_UP"&&(console.warn("THREE.ColladaLoader: You are loading an asset with a Z-UP coordinate system. The loader just rotates the asset to transform it into Y-UP. The vertex data are not converted, see #24289."),Cs.rotation.set(-Math.PI/2,0,0)),Cs.scale.multiplyScalar(St.unit),{get animations(){return console.warn("THREE.ColladaLoader: Please access animations over scene.animations now."),Ut},kinematics:xi,library:Ge,scene:Cs}}}const Vl=new B,Yg=new hn,tr=new Ze,Xn=new Ze,nr=new vn,ir=new B(1,1,1),sr=new B;class Tr extends It{constructor(...e){super(...e),this.urdfNode=null,this.urdfName=""}copy(e,t){return super.copy(e,t),this.urdfNode=e.urdfNode,this.urdfName=e.urdfName,this}}class jg extends Tr{constructor(...e){super(...e),this.isURDFCollider=!0,this.type="URDFCollider"}}class Zg extends Tr{constructor(...e){super(...e),this.isURDFVisual=!0,this.type="URDFVisual"}}class Lc extends Tr{constructor(...e){super(...e),this.isURDFLink=!0,this.type="URDFLink"}}class Dc extends Tr{get jointType(){return this._jointType}set jointType(e){if(this.jointType!==e)switch(this._jointType=e,this.matrixWorldNeedsUpdate=!0,e){case"fixed":this.jointValue=[];break;case"continuous":case"revolute":case"prismatic":this.jointValue=new Array(1).fill(0);break;case"planar":this.jointValue=new Array(3).fill(0),this.axis=new B(0,0,1);break;case"floating":this.jointValue=new Array(6).fill(0);break}}get angle(){return this.jointValue[0]}constructor(...e){super(...e),this.isURDFJoint=!0,this.type="URDFJoint",this.jointValue=null,this.jointType="fixed",this.axis=new B(1,0,0),this.limit={lower:0,upper:0},this.ignoreLimits=!1,this.origPosition=null,this.origQuaternion=null,this.mimicJoints=[]}copy(e,t){return super.copy(e,t),this.jointType=e.jointType,this.axis=e.axis.clone(),this.limit.lower=e.limit.lower,this.limit.upper=e.limit.upper,this.ignoreLimits=!1,this.jointValue=[...e.jointValue],this.origPosition=e.origPosition?e.origPosition.clone():null,this.origQuaternion=e.origQuaternion?e.origQuaternion.clone():null,this.mimicJoints=[...e.mimicJoints],this}setJointValue(...e){e=e.map(n=>n===null?null:parseFloat(n)),(!this.origPosition||!this.origQuaternion)&&(this.origPosition=this.position.clone(),this.origQuaternion=this.quaternion.clone());let t=!1;switch(this.mimicJoints.forEach(n=>{t=n.updateFromMimickedJoint(...e)||t}),this.jointType){case"fixed":return t;case"continuous":case"revolute":{let n=e[0];return n==null||n===this.jointValue[0]?t:(!this.ignoreLimits&&this.jointType==="revolute"&&(n=Math.min(this.limit.upper,n),n=Math.max(this.limit.lower,n)),this.quaternion.setFromAxisAngle(this.axis,n).premultiply(this.origQuaternion),this.jointValue[0]!==n?(this.jointValue[0]=n,this.matrixWorldNeedsUpdate=!0,!0):t)}case"prismatic":{let n=e[0];return n==null||n===this.jointValue[0]?t:(this.ignoreLimits||(n=Math.min(this.limit.upper,n),n=Math.max(this.limit.lower,n)),this.position.copy(this.origPosition),Vl.copy(this.axis).applyEuler(this.rotation),this.position.addScaledVector(Vl,n),this.jointValue[0]!==n?(this.jointValue[0]=n,this.matrixWorldNeedsUpdate=!0,!0):t)}case"floating":return this.jointValue.every((n,s)=>e[s]===n||e[s]===null)?t:(this.jointValue[0]=e[0]!==null?e[0]:this.jointValue[0],this.jointValue[1]=e[1]!==null?e[1]:this.jointValue[1],this.jointValue[2]=e[2]!==null?e[2]:this.jointValue[2],this.jointValue[3]=e[3]!==null?e[3]:this.jointValue[3],this.jointValue[4]=e[4]!==null?e[4]:this.jointValue[4],this.jointValue[5]=e[5]!==null?e[5]:this.jointValue[5],Xn.compose(this.origPosition,this.origQuaternion,ir),nr.setFromEuler(Yg.set(this.jointValue[3],this.jointValue[4],this.jointValue[5],"XYZ")),sr.set(this.jointValue[0],this.jointValue[1],this.jointValue[2]),tr.compose(sr,nr,ir),Xn.premultiply(tr),this.position.setFromMatrixPosition(Xn),this.rotation.setFromRotationMatrix(Xn),this.matrixWorldNeedsUpdate=!0,!0);case"planar":return this.jointValue.every((n,s)=>e[s]===n||e[s]===null)?t:(this.jointValue[0]=e[0]!==null?e[0]:this.jointValue[0],this.jointValue[1]=e[1]!==null?e[1]:this.jointValue[1],this.jointValue[2]=e[2]!==null?e[2]:this.jointValue[2],Xn.compose(this.origPosition,this.origQuaternion,ir),nr.setFromAxisAngle(this.axis,this.jointValue[2]),sr.set(this.jointValue[0],this.jointValue[1],0),tr.compose(sr,nr,ir),Xn.premultiply(tr),this.position.setFromMatrixPosition(Xn),this.rotation.setFromRotationMatrix(Xn),this.matrixWorldNeedsUpdate=!0,!0)}return t}}class Hl extends Dc{constructor(...e){super(...e),this.type="URDFMimicJoint",this.mimicJoint=null,this.offset=0,this.multiplier=1}updateFromMimickedJoint(...e){const t=e.map(n=>n*this.multiplier+this.offset);return super.setJointValue(...t)}copy(e,t){return super.copy(e,t),this.mimicJoint=e.mimicJoint,this.offset=e.offset,this.multiplier=e.multiplier,this}}class Kg extends Lc{constructor(...e){super(...e),this.isURDFRobot=!0,this.urdfNode=null,this.urdfRobotNode=null,this.robotName=null,this.links=null,this.joints=null,this.colliders=null,this.visual=null,this.frames=null}copy(e,t){super.copy(e,t),this.urdfRobotNode=e.urdfRobotNode,this.robotName=e.robotName,this.links={},this.joints={},this.colliders={},this.visual={},this.traverse(n=>{n.isURDFJoint&&n.urdfName in e.joints&&(this.joints[n.urdfName]=n),n.isURDFLink&&n.urdfName in e.links&&(this.links[n.urdfName]=n),n.isURDFCollider&&n.urdfName in e.colliders&&(this.colliders[n.urdfName]=n),n.isURDFVisual&&n.urdfName in e.visual&&(this.visual[n.urdfName]=n)});for(const n in this.joints)this.joints[n].mimicJoints=this.joints[n].mimicJoints.map(s=>this.joints[s.name]);return this.frames={...this.colliders,...this.visual,...this.links,...this.joints},this}getFrame(e){return this.frames[e]}setJointValue(e,...t){const n=this.joints[e];return n?n.setJointValue(...t):!1}setJointValues(e){let t=!1;for(const n in e){const s=e[n];Array.isArray(s)?t=this.setJointValue(n,...s)||t:t=this.setJointValue(n,s)||t}return t}}const fa=new vn,Gl=new hn;function Ni(i){return i?i.trim().split(/\s+/g).map(e=>parseFloat(e)):[0,0,0]}function Wl(i,e,t=!1){t||i.rotation.set(0,0,0),Gl.set(e[0],e[1],e[2],"ZYX"),fa.setFromEuler(Gl),fa.multiply(i.quaternion),i.quaternion.copy(fa)}class Jg{constructor(e){this.manager=e||yc,this.loadMeshCb=this.defaultMeshLoader.bind(this),this.parseVisual=!0,this.parseCollision=!1,this.packages="",this.workingPath="",this.fetchOptions={}}loadAsync(e){return new Promise((t,n)=>{this.load(e,t,null,n)})}load(e,t,n,s){const r=this.manager,a=Tc.extractUrlBase(e),o=this.manager.resolveURL(e);r.itemStart(o),fetch(o,this.fetchOptions).then(c=>{if(c.ok)return n&&n(null),c.text();throw new Error(`URDFLoader: Failed to load url '${o}' with error code ${c.status} : ${c.statusText}.`)}).then(c=>{const l=this.parse(c,this.workingPath||a);t(l),r.itemEnd(o)}).catch(c=>{s?s(c):console.error("URDFLoader: Error loading file.",c),r.itemError(o),r.itemEnd(o)})}parse(e,t=this.workingPath){const n=this.packages,s=this.loadMeshCb,r=this.parseVisual,a=this.parseCollision,o=this.manager,c={},l={},h={};function u(R){if(!/^package:\/\//.test(R))return t?t+R:R;const[C,A]=R.replace(/^package:\/\//,"").split(/\/(.+)/);if(typeof n=="string")return n.endsWith(C)?n+"/"+A:n+"/"+C+"/"+A;if(n instanceof Function)return n(C)+"/"+A;if(typeof n=="object")return C in n?n[C]+"/"+A:(console.error(`URDFLoader : ${C} not found in provided package list.`),null)}function f(R){let C;R instanceof Document?C=[...R.children]:R instanceof Element?C=[R]:C=[...new DOMParser().parseFromString(R,"text/xml").children];const A=C.filter(L=>L.nodeName==="robot").pop();return p(A)}function p(R){const C=[...R.children],A=C.filter(D=>D.nodeName.toLowerCase()==="link"),L=C.filter(D=>D.nodeName.toLowerCase()==="joint"),I=C.filter(D=>D.nodeName.toLowerCase()==="material"),U=new Kg;U.robotName=R.getAttribute("name"),U.urdfRobotNode=R,I.forEach(D=>{const z=D.getAttribute("name");h[z]=m(D)});const N={},y={};A.forEach(D=>{const z=D.getAttribute("name"),H=R.querySelector(`child[link="${z}"]`)===null;c[z]=v(D,N,y,H?U:null)}),L.forEach(D=>{const z=D.getAttribute("name");l[z]=x(D)}),U.joints=l,U.links=c,U.colliders=y,U.visual=N;const M=Object.values(l);return M.forEach(D=>{D instanceof Hl&&l[D.mimicJoint].mimicJoints.push(D)}),M.forEach(D=>{const z=new Set,H=Z=>{if(z.has(Z))throw new Error("URDFLoader: Detected an infinite loop of mimic joints.");z.add(Z),Z.mimicJoints.forEach(ee=>{H(ee)})};H(D)}),U.frames={...y,...N,...c,...l},U}function x(R){const C=[...R.children],A=R.getAttribute("type");let L;const I=C.find(z=>z.nodeName.toLowerCase()==="mimic");I?(L=new Hl,L.mimicJoint=I.getAttribute("joint"),L.multiplier=parseFloat(I.getAttribute("multiplier")||1),L.offset=parseFloat(I.getAttribute("offset")||0)):L=new Dc,L.urdfNode=R,L.name=R.getAttribute("name"),L.urdfName=L.name,L.jointType=A;let U=null,N=null,y=[0,0,0],M=[0,0,0];C.forEach(z=>{const H=z.nodeName.toLowerCase();H==="origin"?(y=Ni(z.getAttribute("xyz")),M=Ni(z.getAttribute("rpy"))):H==="child"?N=c[z.getAttribute("link")]:H==="parent"?U=c[z.getAttribute("link")]:H==="limit"&&(L.limit.lower=parseFloat(z.getAttribute("lower")||L.limit.lower),L.limit.upper=parseFloat(z.getAttribute("upper")||L.limit.upper))}),U.add(L),L.add(N),Wl(L,M),L.position.set(y[0],y[1],y[2]);const D=C.filter(z=>z.nodeName.toLowerCase()==="axis")[0];if(D){const z=D.getAttribute("xyz").split(/\s+/g).map(H=>parseFloat(H));L.axis=new B(z[0],z[1],z[2]),L.axis.normalize()}return L}function v(R,C,A,L=null){L===null&&(L=new Lc);const I=[...R.children];return L.name=R.getAttribute("name"),L.urdfName=L.name,L.urdfNode=R,r&&I.filter(N=>N.nodeName.toLowerCase()==="visual").forEach(N=>{const y=d(N,h);if(L.add(y),N.hasAttribute("name")){const M=N.getAttribute("name");y.name=M,y.urdfName=M,C[M]=y}}),a&&I.filter(N=>N.nodeName.toLowerCase()==="collision").forEach(N=>{const y=d(N);if(L.add(y),N.hasAttribute("name")){const M=N.getAttribute("name");y.name=M,y.urdfName=M,A[M]=y}}),L}function m(R){const C=[...R.children],A=new gs;return A.name=R.getAttribute("name")||"",C.forEach(L=>{const I=L.nodeName.toLowerCase();if(I==="color"){const U=L.getAttribute("rgba").split(/\s/g).map(N=>parseFloat(N));A.color.setRGB(U[0],U[1],U[2]),A.opacity=U[3],A.transparent=U[3]<1,A.depthWrite=!A.transparent}else if(I==="texture"){const U=L.getAttribute("filename");if(U){const N=new Sc(o),y=u(U);A.map=N.load(y),A.map.colorSpace=Pt}}}),A}function d(R,C={}){const A=R.nodeName.toLowerCase()==="collision",L=[...R.children];let I=null;const U=L.filter(y=>y.nodeName.toLowerCase()==="material")[0];if(U){const y=U.getAttribute("name");y&&y in C?I=C[y]:I=m(U)}else I=new gs;const N=A?new jg:new Zg;return N.urdfNode=R,L.forEach(y=>{const M=y.nodeName.toLowerCase();if(M==="geometry"){const D=y.children[0].nodeName.toLowerCase();if(D==="mesh"){const z=y.children[0].getAttribute("filename"),H=u(z);if(H!==null){const Z=y.children[0].getAttribute("scale");if(Z){const ee=Ni(Z);N.scale.set(ee[0],ee[1],ee[2])}s(H,o,(ee,O)=>{O?console.error("URDFLoader: Error loading mesh.",O):ee&&(ee instanceof Ht&&(ee.material=I),ee.position.set(0,0,0),ee.quaternion.identity(),N.add(ee))})}}else if(D==="box"){const z=new Ht;z.geometry=new es(1,1,1),z.material=I;const H=Ni(y.children[0].getAttribute("size"));z.scale.set(H[0],H[1],H[2]),N.add(z)}else if(D==="sphere"){const z=new Ht;z.geometry=new mo(1,30,30),z.material=I;const H=parseFloat(y.children[0].getAttribute("radius"))||0;z.scale.set(H,H,H),N.add(z)}else if(D==="cylinder"){const z=new Ht;z.geometry=new po(1,1,1,30),z.material=I;const H=parseFloat(y.children[0].getAttribute("radius"))||0,Z=parseFloat(y.children[0].getAttribute("length"))||0;z.scale.set(H,Z,H),z.rotation.set(Math.PI/2,0,0),N.add(z)}}else if(M==="origin"){const D=Ni(y.getAttribute("xyz")),z=Ni(y.getAttribute("rpy"));N.position.set(D[0],D[1],D[2]),N.rotation.set(0,0,0),Wl(N,z)}}),N}return f(e)}defaultMeshLoader(e,t,n){/\.stl$/i.test(e)?new Xg(t).load(e,r=>{const a=new Ht(r,new gs);n(a)}):/\.dae$/i.test(e)?new qg(t).load(e,r=>n(r.scene)):console.warn(`URDFLoader: Could not load model at ${e}.
No loader available`)}}const $g=`
//
...
`,Qg=()=>{const i=new Map;return i.set("/language-configuration.json",new URL("data:application/json;base64,",import.meta.url)),i.set("/ssdl-grammar.json",new URL("data:application/json;base64,",import.meta.url)),{wrapperConfig:{serviceConfig:Oc(),editorAppConfig:{$type:"extended",languageId:"ssdl",code:$g,useDiffEditor:!1,extensions:[{config:{name:"ssdl-web",publisher:"generator-langium",version:"1.0.0",engines:{vscode:"*"},contributes:{languages:[{id:"ssdl",extensions:[".ssdl"],configuration:"./language-configuration.json"}],grammars:[{language:"ssdl",scopeName:"source.ssdl",path:"./ssdl-grammar.json"}]}},filesOrContents:i}],userConfiguration:{json:JSON.stringify({"workbench.colorTheme":"Default Dark Modern","editor.semanticHighlighting.enabled":!0})}}},languageClientConfig:Fc()}},e_=async i=>{const e=Qg(),t=new Uc;await t.initAndStart(e,i);const n=t.getLanguageClient();if(!n)throw new Error("Unable to obtain language client.");const s=800;let r=!1,a=null,o,c,l,h,u;f(),p(),n.onNotification("browser/DocumentChange",m=>{r||(a&&clearTimeout(a),a=setTimeout(async()=>{r=!0;const d=m.urdf,R=m.config;m.diagnostics,await v(d,R),r=!1},s))});function f(){l=new pc,l.background=new Je(2503224),h=new qt,h.position.set(-10,10,10),h.lookAt(0,0,0),o=new Pg({antialias:!0}),o.shadowMap.enabled=!0,o.shadowMap.type=ql,c=document.getElementById("rendered-view"),c?c.appendChild(o.domElement):document.body.appendChild(o.domElement);const m=new Ec;m.castShadow=!0,m.shadow.mapSize.setScalar(1024),m.position.set(5,30,5),l.add(m);const d=new bc(16777215,.2);l.add(d);const R=20,C=new Ht(new ys,new Su({opacity:.25}));C.rotation.x=-Math.PI/2,C.scale.setScalar(R),C.receiveShadow=!0,l.add(C);const A=new Wu(R,R,0,8421504);l.add(A);const L=new Xu(R/2);L.position.y=.001,l.add(L);const I=new Lg(h,o.domElement);I.minDistance=4,I.target.y=1,I.update(),x(),window.addEventListener("resize",x)}function p(){requestAnimationFrame(p),o.render(l,h)}function x(){c&&(o.setSize(c.offsetWidth,c.offsetHeight),o.setPixelRatio(window.devicePixelRatio),h.aspect=c.offsetWidth/c.offsetHeight,h.updateProjectionMatrix())}function v(m,d,R){if(m==="")return;u!==void 0&&l.remove(u);const C=new Jg;try{u=C.parse(m)}catch(L){console.error("Error parsing URDF:",L);return}u.traverse(L=>{L.castShadow=!0});const A=d.get("visual_scale")??1;if(u.scale.setScalar(A),u.rotation.x=Math.PI/2,d.get("snap_to_ground")===!0){const L=new mi;L.setFromObject(u),u.position.y-=L.min.y}l.add(u)}};Bc();e_(document.getElementById("monaco-editor-root"));
